The Improved Multi Select module for Drupal 7 replace the default multi-select
...
You can select an item from the first box, click the add button, and
add it to the second box. Likewise, you can select an item from the second box,
